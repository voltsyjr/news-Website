<!-- //Setting condition that if a user is loged in than it ia able to acces admin panel otherwise ti should redirect to login page  -->
<?php
                ...
                <div class="row">
                    <div class="col-md-12">
                       <ul class="admin-menu">
                            ...
                            <!-- makin that user havin admin role could only see Category and Users -->
                            <?php
